...
if __name__ == '__main__':
    rospy.init_node('ugly_duckling_listener')
...
# the param turtle (default to turtle2)
    ...
    turtle_name = rospy.get_param('turtle', 'turtle5')
    spawner(2, 2, 0, turtle_name)
...
# This is the most important line. Requests the transform between turtle1 and turtle_name
            trans = tfBuffer.lookup_transform(turtle_name, 'turtle4', rospy.Time())
